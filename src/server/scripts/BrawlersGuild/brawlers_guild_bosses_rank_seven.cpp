...
public:
    ...
    struct boss_brawguild_nibleahAI : public BossAI
    {
        boss_brawguild_nibleahAI(Creature* creature) : BossAI(creature, DATA_BOSS_RANK_SEVEN) {}
...
public:
    ...
    struct boss_brawguild_serpentAI : public BossAI
    {
        boss_brawguild_serpentAI(Creature* creature) : BossAI(creature, DATA_BOSS_RANK_SEVEN) {}
...
public:
    ...
    struct boss_brawguild_epicusAI : public BossAI
    {
        boss_brawguild_epicusAI(Creature* creature) : BossAI(creature, DATA_BOSS_RANK_SEVEN) {}
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            {
            case 67490:
                events.RescheduleEvent(1, 28000);
                break;
            case 67492:
                events.RescheduleEvent(2, urand(29000, 30000));
                break;
            case 67495:
...
public:
    ...
    struct boss_brawguild_raydAI : public BossAI
    {
        boss_brawguild_raydAI(Creature* creature) : BossAI(creature, DATA_BOSS_RANK_SEVEN) {}
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case 1:
                    ...
                    phase++;
                    events.RescheduleEvent(1, urand(11000, 12000));
                    break;
                }
            }
