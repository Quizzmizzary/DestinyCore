    ...
    struct boss_brawguild_thwack_uAI : public BossAI
    {
        ...
        {           
            if (me->GetEntry() == 114944)
                ...
                events.RescheduleEvent(2, urand(16000, 18000));
        }
...
public:
    ...
    struct boss_brawguild_five_gnomesAI : public BossAI
    {
        ...
        {           
            events.RescheduleEvent(1, 4000);
            events.RescheduleEvent(2, urand(3000, 8000));
        }
...
public:
    ...
    struct boss_brawguild_blackmangeAI : public BossAI
    {
        ...
        void EnterCombat(Unit* who) override
        {
            ...
            events.RescheduleEvent(1, 21000);
        }
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case 1:
                        ...
                        events.RescheduleEvent(1, urand(19000, 21000));
                        break;
                }
            }
