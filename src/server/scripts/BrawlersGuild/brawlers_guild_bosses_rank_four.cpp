        ...
        {                       
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    events.RescheduleEvent(1, urand (17000, 19000));
                    break;
                }
            }
...
public:
    ...
    struct boss_brawguild_meatballAI : public BossAI
    {
       ...
       void EnterCombat(Unit* /*who*/) override
        {
            events.RescheduleEvent(1, 60000);
