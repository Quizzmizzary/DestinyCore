...
public:
    ...
    struct boss_brawguild_toppsAI : public BossAI
    {
        boss_brawguild_toppsAI(Creature* creature) : BossAI(creature, DATA_BOSS_RANK_SIX) {}
...
public:
    ...
    struct boss_brawguild_millieAI : public BossAI
    {
        boss_brawguild_millieAI(Creature* creature) : BossAI(creature, DATA_BOSS_RANK_SIX) {}
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            events.RescheduleEvent(3, 33000);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case 1:
                    ...
                    events.RescheduleEvent(2, 5200);
                    break;
                case 2:
                    DoCast(SPELL_ELECTRIC_DYNAMITE);
                    events.RescheduleEvent(1, 1100);
                    break;
                case 3:
...
public:
    ...
    struct boss_brawguild_carlAI : public BossAI
    {
        boss_brawguild_carlAI(Creature* creature) : BossAI(creature, DATA_BOSS_RANK_SIX) {}
        ...
        {
            events.RescheduleEvent(1, 2000);
            events.RescheduleEvent(2, 33000);
            events.RescheduleEvent(3, 16000);
            if (Unit* unit = me->GetOwner())
                if (Player* owner = unit->ToPlayer())
                {
...
public:
    ...
    struct npc_brawguild_ogrewatch_controllerAI : public BossAI
    {
        npc_brawguild_ogrewatch_controllerAI(Creature* creature) : BossAI(creature, DATA_BOSS_RANK_SIX) {}
...
public:
    ...
    struct boss_brawguild_ogrewatchAI : public BossAI
    {
        boss_brawguild_ogrewatchAI(Creature* creature) : BossAI(creature, DATA_BOSS_RANK_SIX) {}
        ...
        void EnterCombat(Unit* who) override
        {
            ...
            case 114955:
                ...
                events.RescheduleEvent(7, 80000);
                me->SetReactState(REACT_PASSIVE);
                break;
            case 114941:
                events.RescheduleEvent(3, 6000);
                events.RescheduleEvent(4, 20000);
                break;
            }
        }
